...
// this is true if:
// IF If a local endpoints resource is present. Regardless whether the
...
func (s *ServiceCache) MergeExternalServiceUpdate(service *serviceStore.ClusterService, swg *lock.StoppableWaitGroup) {
	...
	s.mergeServiceUpdate(service, nil, swg)
}

func (s *ServiceCache) mergeServiceUpdate(service *serviceStore.ClusterService, oldService *Service, swg *lock.StoppableWaitGroup) {
...
func (s *ServiceCache) MergeClusterServiceUpdate(service *serviceStore.ClusterService, swg *lock.StoppableWaitGroup) {
	...
	s.mergeServiceUpdate(service, oldService, swg)
}
